    ...
    <div className={`min-h-screen flex items-center justify-center px-4 py-8 relative overflow-hidden transition-all duration-500 ${isDark ? 'dark' : ''}`}>
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="relative group">
          ...
          >
            {/* Animated Top Border */}
            <div className={`absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent ${isDark ? 'via-cyan-500/30' : 'via-blue-500/50'
                    ...
                    <div className="relative">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <p className={`text-xs ${isDark ? 'text-emerald-500/80' : 'text-emerald-600/80'
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center justify-center space-x-3">
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isDark ? 'bg-gray-800 group-hover:bg-gray-700' : 'bg-gray-100 group-hover:bg-gray-300'
                        } transition-colors`}>
                        <Github className={`w-4 h-4 ${isDark ? 'text-gray-300' : 'text-gray-600'}`} />
                      </div>
                      <span className={`${t.socialText} font-medium group-hover:${isDark ? 'text-white' : 'text-gray-900'
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-2 pt-2">
                      <input
                        ...
                        type="checkbox"
                        required
                        className={`h-3.5 w-3.5 mt-0.5 rounded ${isDark ? 'bg-gray-800 border-white/10 text-cyan-500' : 'bg-white border-gray-300 text-blue-600'
                          } focus:${isDark ? 'ring-cyan-500/20' : 'ring-blue-400/30'
                          }`}
                      />
                      <label htmlFor="terms" className={`text-xs ${t.subtext}`}>
                        I agree to the{" "}
                        <Link to="/terms" className={`font-medium ${isDark ? 'text-cyan-400 hover:text-cyan-300' : 'text-blue-600 hover:text-blue-700'
                          } transition-colors`}>
                          Terms of Service
                        </Link>{" "}
                        and{" "}
                        <Link to="/privacy" className={`font-medium ${isDark ? 'text-cyan-400 hover:text-cyan-300' : 'text-blue-600 hover:text-blue-700'
                          } transition-colors`}>
                          Privacy Policy
                        </Link>
                      </label>
