        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold tracking-tight bg-linear-to-r from-white to-gray-400 bg-clip-text text-transparent">
                  Command Center
                </h1>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { label: 'Total Posts', value: stats?.posts || 0, icon: Code2, trend: 'Deployments', color: 'text-blue-400' },
                { label: 'Created Guilds', value: stats?.created_communities || 0, icon: LayoutDashboard, trend: 'Owner', color: 'text-cyan-400' },
                { label: 'Joined Guilds', value: stats?.communities || 0, icon: Users, trend: 'Member', color: 'text-green-400' },
                { label: 'Target Events', value: stats?.events || 0, icon: Calendar, trend: 'Schedule', color: 'text-purple-400' },
              ].map((stat, i) => (
                <StatCard
                  key={i}
                  label={stat.label}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                <div className="bg-linear-to-br from-cyan-900/20 to-slate-900/40 border border-cyan-900/30 rounded-xl p-6 relative overflow-hidden">
                  <div className="absolute -bottom-8 -right-8 opacity-10">
                    <LayoutDashboard className="w-32 h-32 text-cyan-400" />
                  </div>
                  <div className="relative z-10 text-center">
                    <div className="inline-block p-1 bg-linear-to-tr from-cyan-500 to-blue-500 rounded-full mb-4">
                      <img
                    ...
                    <div className="mt-4 flex justify-center">
                      <div className="bg-slate-950/50 p-2 rounded border border-slate-800 w-full max-w-30">
