...
export default function Footer() {
  ...
  const footerClasses = isDark
    ? "relative bg-linear-to-b from-gray-900 via-gray-900 to-black border-t border-cyan-900/30 text-gray-300 overflow-hidden pt-12"
    : "relative bg-linear-to-b from-white via-gray-50 to-gray-100 border-t border-blue-200 text-gray-700 overflow-hidden pt-12";

  const scrollTopButtonClasses = isDark
    ? "fixed right-6 bottom-6 z-50 p-3 bg-linear-to-br from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white rounded-full shadow-lg hover:shadow-cyan-500/25 transition-all duration-300 hover:scale-110 active:scale-95 group"
    : "fixed right-6 bottom-6 z-50 p-3 bg-linear-to-br from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white rounded-full shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-110 active:scale-95 group";
  ...
  return (
    <>
      <footer className={footerClasses}>
        ...
        <button
          onClick={toggleTheme}
          className={`fixed left-6 bottom-6 z-50 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 ${isDark
        ...
        <div className={statsBarClasses}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border ${isDark
              ...
              <div className={`text-sm px-3 py-1.5 rounded-lg ${isDark
              ...
              <div className="flex gap-3 pt-2">
                {[
                  ...
                  <a
                    ...
                    className={`p-2.5 rounded-lg border ${social.color} transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 ${isDark
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className={`relative w-full pl-10 pr-4 py-3 ${inputBg} rounded-xl ${isDark ? 'text-white' : 'text-gray-900'} placeholder-gray-500 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 focus:shadow-lg z-10 ${isDark
                ...
                <button
                  ...
                  className={`w-full py-3 px-4 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden group/button ${subscriptionSuccess
                    ...
                    } hover:shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed text-white ${isDark
              ...
              <div className="flex flex-wrap gap-4 text-sm group/links">
                {[
                  ...
                  <Link
                    key={i}
                    to={item.path}
                    className={`transition-all duration-300 relative group/link overflow-hidden ${isDark
                  ...
                  >
                    ...
                    <span
                      className={`absolute bottom-0 left-0 w-0 h-0.5 group-hover/link:w-full transition-all duration-300 ${isDark ? 'bg-cyan-400' : 'bg-blue-500'
                        }`}
                    ></span>
                  </Link>
                ))}
        ...
        <div className="absolute bottom-24 right-6 lg:right-10 hidden lg:block">
          <div className="relative group">
            <div className={`absolute inset-0 rounded-full blur-xl ${isDark ? 'bg-cyan-500/20' : 'bg-blue-500/10'
              }`}></div>
            <div className={`relative p-3 backdrop-blur-sm border rounded-2xl shadow-lg group-hover:scale-105 transition-all duration-300 ${isDark
