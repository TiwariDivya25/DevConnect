          ...
          <div className={`pt-8 border-t ${borderColor} relative group/bottom`}>
            ...
            <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-4 text-sm group/links">
                {["Privacy", "Terms", "Cookies", "Security", "Status", "Docs"].map((item, i) => (
                  <a
                    key={i}
                    href={item === "Docs" ? "/docs" : "#"}
                  ...
                  >
                    ...
                    <span className={`absolute bottom-0 left-0 w-0 h-0.5 group-hover/link:w-full transition-all duration-300 ${isDark ? 'bg-cyan-400' : 'bg-blue-500'
                      }`}></span>
                  </a>
                ))}
                <Link
