    ...
    <nav className="bg-slate-950 border-b border-cyan-900/30 text-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 font-mono font-bold text-xl hover:text-cyan-400 transition group flex-shrink-0 ml-4"
          >
          ...
          <div className="hidden md:flex items-center justify-center gap-6 flex-1 px-8">
            ...
            <Link
              to="/contributors"
              className="font-mono text-sm text-gray-300 hover:text-cyan-400 transition duration-200 whitespace-nowrap mr-4"
            >
              ~/contributors
            </Link>
          </div>
            ...
            <div className="pb-4 pt-2 border-t border-cyan-900/30 bg-slate-900/95">
              <div className="flex flex-col gap-2">
                <Link
                  ...
                  className="block px-4 py-3 font-mono text-sm text-gray-300 hover:text-cyan-400 hover:bg-cyan-900/20 rounded transition flex items-center gap-3 ml-4"
                >
                  ~/home
                </Link>
                <Link
                ...
                <Link
                  to="/contributors"
                  onClick={() => setIsMenuOpen(false)}
                  className="block px-4 py-3 font-mono text-sm text-gray-300 hover:text-cyan-400 hover:bg-cyan-900/20 rounded transition flex items-center gap-3 mr-4"
                >
                  ~/contributors
                </Link>
              </div>
