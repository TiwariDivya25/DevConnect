    ...
    <nav className="bg-slate-950 border-b border-cyan-900/30 text-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 font-mono font-bold text-xl hover:text-cyan-400 transition group shrink-0 ml-4"
          >
          ...
          <div className="hidden md:flex items-center justify-center gap-6 flex-1 px-8">
            ...
            <Link
              to="/"
              className="font-mono text-sm text-gray-300 hover:text-cyan-400 transition duration-200 whitespace-nowrap ml-4"
            >
              ~/home
            </Link>
            <Link
            ...
            <Link
              to="/events"
              className="font-mono text-sm text-gray-300 hover:text-cyan-400 transition duration-200 whitespace-nowrap flex items-center gap-1"
            >
              ~/events
            </Link>
            <Link
